...
consvar_t cv_mousesens = {"mousesens", "50", CV_SAVE, mousesens_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_mlooksens = {"mlooksens", "50", CV_SAVE, mousesens_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_mousesens2 = {"mousesens2", "50", CV_SAVE, mousesens_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
consvar_t cv_mlooksens2 = {"mlooksens2", "50", CV_SAVE, mousesens_cons_t, NULL, 0, NULL, NULL, 0, 0, NULL};
...
void G_Controldefault(void)
{
	...
	gamecontrol[gc_normalring ][0] = '1';
	gamecontrol[gc_autoring   ][0] = '2';
	gamecontrol[gc_bouncering ][0] = '3';
	gamecontrol[gc_scatterring][0] = '4';
	gamecontrol[gc_grenadering][0] = '5';
	gamecontrol[gc_explosionring][0] = '6';
	gamecontrol[gc_railring   ][0] = '7';
