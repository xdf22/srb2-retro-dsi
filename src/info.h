...
void A_SnowBall(void *actor); // Snowball function for Snow Buster
...
void A_Invinciblerize(void *actor);
void A_DeInvinciblerize(void *actor);
...
void A_BossZoom(void *actor); //Usused
